...
{
	TEST_EQ(lodDay7Part1("AOC_Day7Test.txt"), 0);
	TEST_EQ(lodDay7Part1("AOC_Day7Part1.txt"), 0);
}
...
{
	TEST_EQ(locDay7Part2("AOC_Day7Test.txt"), 0);
	TEST_EQ(locDay7Part2("AOC_Day7Part1.txt"), 0);
}
